...
As a visiting scholar at the Raman Research Institute (RRI), Bengaluru, I worked on <b><a href="https://arxiv.org/abs/1903.11544" target="_self">causal set theory</a></b>, an approach to quantum gravity that postulates that spacetime is fundamentally discrete and replaces the spacetime continuum with locally finite posets. However, non-manifold-like causal sets are far more typical than manifold-like ones -- this poses a challenge to causal set theory, since continuum-like dynamics must arise from the fundamentally discrete dynamics in the semi-classical limit. A <b><a href="https://arxiv.org/abs/2009.07623" target="_self">result</a></b> from my collaboration with Dr. Abhishek Mathur and Prof. Sumati Surya at RRI, helped establish that certain classes of non-manifold-like causal sets are suppressed even though they are more typical than manifold-like causal sets, allowing for the possibility that the causal set path-sum can lead to emergent manifold-like behavior.
