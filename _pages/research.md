...
At the moment, we are also working on using gauge-theoretic ideas to construct a Lagrangian multiform for the Hitchin integrable system. The Hitchin system is related to vector bundles on Riemann surfaces and unifies many interesting integrable models -- its multiform description will therefore be an important addition to the theory of Lagrangian multiforms. A related long*ish*-term goal is to use our construction together with the path integral formalism to quantise integrable theories in a covariant manner.
